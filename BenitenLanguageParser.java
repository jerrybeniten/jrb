...
public class BenitenLanguageParser extends Parser {
	...
	public static final int
		...
		NEQ=18, SNEQ=19, LT=20, GT=21, LE=22, GE=23, VARIABLE=24, ID=25, FLOAT_LITERAL=26, 
		INT_LITERAL=27, STRING=28, BOOL_LITERAL=29, LPAR=30, RPAR=31, LBRACE=32, 
		RBRACE=33, SEMI=34, COMMA=35, COLON=36, ASSIGN=37, LINE_COMMENT=38, BLOCK_COMMENT=39, 
		WS=40;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LT", "GT", "LE", "GE", "VARIABLE", "ID", "FLOAT_LITERAL", "INT_LITERAL", 
			"STRING", "BOOL_LITERAL", "LPAR", "RPAR", "LBRACE", "RBRACE", "SEMI", 
